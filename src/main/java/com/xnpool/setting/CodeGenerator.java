...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir(userPath + "/src/main/java");    //生成文件的输出目录
        gc.setAuthor("zly");                    //作者
        ...
        dsc.setUrl("jdbc:mysql://182.92.235.178:3306/xnpool_mine?useUnicode=true&characterEncoding=utf8&serverTimezone=Asia/Shanghai");
